%%%-------------------------------------------------------------------
%%% @doc Microbenchmark for {@link sonde_layout:split/3}.
%%%
...
%%%
%%% The parent rect is built via {@link sonde_layout:area/1} so this module
