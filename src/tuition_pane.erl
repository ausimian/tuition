...
%%% tuition_shell} can host any of them without knowing which: it drives the shared
...
%%% across frames — the renderer is immediate-mode (see {@link tuition_widget}), so a
