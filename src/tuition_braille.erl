...
-doc """
A blank grid sized by `Rect`: `W`×`H` cells, a `2W`×`4H` sub-pixel field.
The rect's origin is where `render_into/2` will composite the cells, so
...
-doc """
The sub-pixel extent `{2W, 4H}` of the grid — the exclusive upper bound on
